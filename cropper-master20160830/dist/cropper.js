...
//		options.aspectRatio = 5 / 4; // 0 -> NaN
	...
	$.extend(prototype, {
		...
		setAspectRatio: function(aspectRatio) {
			...
			if(!this.disabled && !isUndefined(aspectRatio)) {
				...
				//      options.aspectRatio = num(aspectRatio) || 5/4; // 0 -> NaN
	...
	Cropper.DEFAULTS = {
		...
		// Toggles
		strict: false, // strict mode, the image cannot zoom out less than the container
		responsive: false, // Rebuild when resize the window
